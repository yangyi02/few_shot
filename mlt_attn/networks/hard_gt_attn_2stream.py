...
class HardGtAttn2StreamNet(nn.Module):
    def __init__(self, im_size, im_channel, dp_channel, num_class):
        super(HardGtAttn2StreamNet, self).__init__()
        num_hidden_i = 24
    ...
    def forward(self, image, depth, box, direction):
        ...
        crop_dp = self.crop_image(depth, box)
        x0 = crop_im
        x0 = self.bn_i0(x0)
