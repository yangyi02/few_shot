...
def parse_args():
    ...
    arg_parser.add_argument('--data', default='vdrift')
    ...
    arg_parser.add_argument('--image_height', type=int, default=240)
    arg_parser.add_argument('--image_width', type=int, default=320)
    arg_parser.add_argument('--output_height', type=int, default=240)
    arg_parser.add_argument('--output_width', type=int, default=320)
    ...
    arg_parser.add_argument('--flow_x_name', default='')
    arg_parser.add_argument('--flow_y_name', default='')
