...
class Seg3DNet(nn.Module):
    def __init__(self, im_channel, dp_channel, num_class):
        super(Seg3DNet, self).__init__()
        num_hidden = 24
        ...
        self.conv7 = nn.Conv2d(num_hidden * 24, num_hidden * 24, 3, 1, 1)
        self.bn7 = nn.BatchNorm2d(num_hidden * 24)
        self.conv = nn.Conv2d(num_hidden * 24, num_class, 3, 1, 1)
        self.conv_of = nn.Conv2d(num_hidden * 24, 4, 3, 1, 1)
